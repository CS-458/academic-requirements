...
test("Test String Processing", () => {
  ...
  if (!stringProcess.courseInListCheck(null, ["CS-144"], undefined).returnValue) {
    throw new Error("");
  }

  // true -> string compare is undefined, so always true
  if (!stringProcess.courseInListCheck(undefined, ["CS-144"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (stringProcess.courseInListCheck("CS-144", undefined, undefined).returnValue) {
    throw new Error("");
  }

  // true -> one course comparison matches
  if (!stringProcess.courseInListCheck("CS-144", ["CS-144"], undefined).returnValue) {
    throw new Error("");
  }

  // false -> one course comparison not matches
  if (stringProcess.courseInListCheck("CS-144", ["CS-145"], undefined).returnValue) {
    throw new Error("");
  }

  // false -> one course missing from AND
  if (stringProcess.courseInListCheck("CS-144,CS-145", ["CS-144", "CS-146"], undefined).returnValue) {
    throw new Error("");
  }

  // true -> both courses match AND
  if (!stringProcess.courseInListCheck("CS-144,CS-145", ["CS-144", "CS-145"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (!stringProcess.courseInListCheck("CS-144|CS-145", ["CS-144", "CS-147"], undefined).returnValue) {
    throw new Error("");
  }

  // true -> other course matches OR
  if (!stringProcess.courseInListCheck("CS-144|CS-145", ["CS-145", "CS-147"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (stringProcess.courseInListCheck("CS-144|CS-145", ["CS-148", "CS-142"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (stringProcess.courseInListCheck("gibberish", ["CS-144", "CS-146"], undefined).returnValue) {
    throw new Error("");
  }

  // false -> garbage put in for course compare
  if (stringProcess.courseInListCheck("CS-144", ["garbage", "icky"], undefined).returnValue) {
    throw new Error("");
  }

  // true -> garbage put in for one course, but rest match
  if (!stringProcess.courseInListCheck("CS-144,CS-145", [
    "CS_144",
    "garbage",
    "CS-145",
    "icky"
  ...
  if (!stringProcess.courseInListCheck("CS-144,CS_145,CS-146", [
    "CS_144",
    "CS-145",
    "CS_146"
  ], undefined).returnValue) {
  ...
  if (!stringProcess.courseInListCheck(
    "!CS-144,CS-130",
    ["CS-130", "CS-180"],
    ["CS-144"]
  ).returnValue) {
  ...
  if (!stringProcess.courseInListCheck("CS-100&CS_101&CS-102", [
    "CS-102",
    "CS-101",
    "CS-100"
  ], undefined).returnValue) {
  ...
  if (!stringProcess.courseInListCheck(">CS-101", ["CS-102"], undefined).returnValue) {
    throw new Error("");
  }

  // false -> course above minimum is not taken
  if (stringProcess.courseInListCheck(">CS-101", ["CS-100"], undefined).returnValue) {
    throw new Error("");
  }

  // true -> course above minimum is taken with an AND
  if (!stringProcess.courseInListCheck("CS-101,>CS-102", [
    "CS-100",
    "CS-101",
    "CS-103"
  ], undefined).returnValue) {
  ...
  if (!stringProcess.courseInListCheck("CS-101|>MSCS-102", [
    "MSCS-100",
    "CS-101",
    "MSCS-103"
  ], undefined).returnValue) {
  ...
  if (stringProcess.courseInListCheck("CS-103|>MSCS-102", [
    "MSCS-100",
    "CS-101",
    "MSCS-101"
  ], undefined).returnValue) {
  ...
  if (stringProcess.courseInListCheck("CS-101,>CS100", [
    "CS-101",
    "CS-101",
    "CS-101"
  ], undefined).returnValue) {
  ...
  if (!stringProcess.courseInListCheck("GDD_325,CS-326&CS_358|DES-350", [
    "GDD_101",
    "CS-358",
    "CS-134",
    "CS_123",
  ...
  if (!stringProcess.courseInListCheck(
    "PSYC-121|PSYC-225|PSYC-280|PSYC-333|PSYC-355|PSYC-370|PSYC-371|PSYC-377|PSYC-381|PSYC-382|PSYC-291",
    ["PSYC-371"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (!stringProcess.courseInListCheck(
    "PSYC-121|PSYC-225|PSYC-280|PSYC-333|PSYC-355|PSYC-370|PSYC-371|PSYC-377|PSYC-381|PSYC-382|PSYC-291",
    ["PSYC-382"], undefined).returnValue
  ) {
    throw new Error("");
  }
  ...
  if (!stringProcess.courseInListCheck(
    "PSYC-121|PSYC-225|PSYC-280|PSYC-333|PSYC-355,PSYC-370|PSYC-371|PSYC-377|PSYC-381|PSYC-382|PSYC-291",
    ["PSYC-377", "PSYC_280"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (stringProcess.courseInListCheck(
    "PSYC-121|PSYC-225|PSYC-280|PSYC-333|PSYC-355,PSYC-370|PSYC-371|PSYC-377|PSYC-381|PSYC-382|PSYC-291",
    ["PSYC-377", "PSYC_283"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (!stringProcess.courseInListCheck(
    "!PSYC-121|!PSYC-225|!PSYC-280|!PSYC-333|!PSYC-355,!PSYC-370|!PSYC-371|!PSYC-377|!PSYC-381|!PSYC-382|!PSYC-291",
    ["PSYC-377", "PSYC-333"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (!stringProcess.courseInListCheck(
    ...
    ["MATH-270", "MATH-157", "MATH-275", "MATH-158"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (!stringProcess.courseInListCheck(
    "MATH-154|MATH-157,MATH-270,MATH-275,MATH-158|>MSCS-200|>STAT-300",
    ["MATH-270", "MATH-157", "MATH-275", "MSCS-209"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (!stringProcess.courseInListCheck(
    "MATH-154|MATH-157,MATH-270,MATH-275,MATH-158|>MSCS-200|>STAT-300",
    ["MATH-270", "MATH-157", "MATH-275", "STAT-300"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (stringProcess.courseInListCheck(
    "MATH-154|MATH-157,MATH-270,MATH-275,MATH-158|>MSCS-200|>STAT-300",
    ["MATH-270", "MATH-157", "MATH-275", "MSCS-170", "STAT-201"], undefined).returnValue) {
    throw new Error("");
  }
  ...
  if (!stringProcess.courseInListCheck(
    ...
    ["MATH-158"]).returnValue) {
    throw new Error("");
  }

  // true (concrete course is taken)
  if (!stringProcess.courseInListCheck("NANO_230|>CHEM_200|>PHYS_281", [
    "MATH-270",
    "NANO-230"
  ], undefined).returnValue) {
    throw new Error("");
